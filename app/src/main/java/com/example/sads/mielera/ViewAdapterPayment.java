 ...
 */
public class ViewAdapterPayment  extends RecyclerView.Adapter<ViewAdapterPayment.MyViewHolder> implements View.OnLongClickListener,View.OnClickListener{
    private Context ctx;
    ...
    public ViewAdapterPayment(ArrayList<Data_Payment> data, Context context) {
        this.data = data;
        this.ctx= context;
    }
    @Override
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view  = LayoutInflater.from(parent.getContext()).inflate(R.layout.custom_payment,parent,false);
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        holder.Quantity_payment.setText(data.get(position).getQuantity_payment());
        holder.Quantity_recived.setText(data.get(position).getQuantity_received());
    ...
    class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        TextView Date;
        TextView Quantity_recived;
        TextView Quantity_payment;
        ImageView image;
        ...
        public MyViewHolder(View itemView, Context ctx, ArrayList<Data_Payment> da) {
            ...
            Quantity_payment = (TextView) itemView.findViewById(R.id.List_Quantity_Payment);
            image = (ImageView) itemView.findViewById(R.id.ListIcon);
            Date = (TextView) itemView.findViewById(R.id.ListFecha);
            Quantity_recived= (TextView)itemView.findViewById(R.id.List_Quantity_received);
        }
