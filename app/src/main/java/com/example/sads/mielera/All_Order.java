...
public class All_Order extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_all__order, container, false);
        datos = new ArrayList<Data_Orders>();
        getUrl= new URL();
        mRecyclerView = (RecyclerView) view.findViewById(R.id.my_recycler_orders);
        registerForContextMenu(mRecyclerView);
        AllOrders(getUrl.GetUrl() +"/Movil/Selecte_Orders.php");
...
/*
    public void llenar(){
        for (int i = 0; i < 10; i++) {
            datos.add(new Data_Orders("Samuel",R.mipmap.ic_launcher,"2016-07-21","20","10"));
                    ...
                    public void onResponse(String response) {
                        if (response.length() > 0) {
                            ...
                            try {
                                ...
                                adapter = new ViewAdapterOrders(datos,getActivity());// Send data at ViewAdapter
